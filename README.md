...
There are four types of sequencing errors that can be corrected after applying ALEC: 1) random mismatches; 2) random indels; 3) indels within homopolymers; and 4) indels near sequence variants.
